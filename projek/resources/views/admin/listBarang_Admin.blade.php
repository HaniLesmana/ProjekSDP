            ...
            @for($i = 0; $i < count($barang); $i++)
                <tr>
                    ...
                    <button type="submit" style="border-radius:3px;border:1px solid black; background-color:#FACE7F;">
                        <a href="/admin/editBarang/{{$barang[$i]->barang_id}}" style="text-decoration: :none; color:white;">
                            Edit
                        </a>
                    </button>
                    </td>
                    {{-- <td>
                        <button type="submit" style="text-decoration: none; border:none; background-color:white; text-align:center;">
                            ...
                            <a href="/admin/prosesDeleteBarang/{{$barang[$i]->barang_id}}" style="text-decoration: :none; color:white;">
                                Delete
                            </a>
                        </button>
                    </td> --}}
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form method="get" action="{{ url("/admin/prosesDeleteBarang/".$barang[$i]->barang_id) }}">
