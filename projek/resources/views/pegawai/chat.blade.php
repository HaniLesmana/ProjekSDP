            ...
            <div class="chat">
                ...
                <div class="chat-message clearfix">
                    <div class="input-group mb-0">
                        ...
                        <input type="text" class="form-control" placeholder="Enter text here..." id="inputchattext">
                        <div class="input-group-append">
                            <button type="submit" class="btn" id="btnsend"><i class="fa fa-send"></i></button>
                        </div>
                    </div>
                </div>
            </div>
...
function insertChatAjax() {
    ...
    $.ajax({
        type: 'post',
        url: '/pegawai/chat_ajax_pegawai_insert/',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data:{
