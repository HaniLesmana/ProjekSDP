@extends('user.base-layout')
    ...
    <div class="container">
    <h2>Withdraw</h2>
    <form method="post" action="{{ url('/pegawai/do_wd') }}">
        @csrf
        <!-- NEW GRID -->
        <style>
            body{
            ...
            <div class="row">
                <div style="display:inline-block;width:100%;margin-top:20px;padding:0px 1.2%;">
                    <div style="float:left">
                        <a href="{{ url('/home/pegawai') }}"><button type="button" class="btn btn-danger" style="color:white;padding:12px 20px;font-size:18px;">Cancel</button></a>
                    </div>
