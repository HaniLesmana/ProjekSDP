...
<html style="font-size: 16px;">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('nicepage/nicepage.css')}}" media="screen">
    {{-- <link rel="stylesheet" href="Home.css" media="screen"> --}}
    <link rel="stylesheet" href="{{asset('nicepage/home.css')}}" media="screen">
    {{-- <script class="u-script" type="text/javascript" src="jquery.js" defer=""></script> --}}
    <script class="u-script" type="{{asset('nicepage/jquery')}}" src="jquery.js" defer=""></script>
    {{-- <script src="{{asset('js/jquery.min.js')}}"></script> --}}
    {{-- <script class="u-script" type="text/javascript" src="nicepage.js" defer=""></script> --}}
    <script class="u-script" type="text/javascript" src="{{asset('nicepage/nicepage.js')}}" defer=""></script>
  ...
  <body data-home-page="{{asset('nicepage/home.css')}}" data-home-page-title="Home" class="u-body"><header class="u-clearfix u-header u-header" id="sec-c575"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-white u-section-1" id="carousel_15d1">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <h1 class="u-text u-text-1">Profile</h1>
        <p class="u-large-text u-text u-text-variant u-text-2">I'm a {{$pegawai->pegawai_jasa}}</p>
        <div class="u-clearfix u-layout-wrap u-layout-wrap-1">
          <div class="u-gutter-0 u-layout">
            <div class="u-layout-col">
              <div class="u-align-center u-container-style u-layout-cell u-size-20 u-layout-cell-1">
                <div class="u-container-layout u-valign-middle u-container-layout-1">
                  {{-- <div alt="" class="u-image u-image-circle u-image-1" data-image-width="626" data-image-height="417"> --}}
                    @if ($pegawai->pegawai_jasa=="Cleaning")
                    <div alt="" class="u-image u-image-circle" style="  width: 239px;height: 239px;  background-position: 50% 50%;margin: 0 auto;background-image:url({{asset('img/img2.png')}})" data-image-width="626" data-image-height="417">
                    @else
                    <div alt="" class="u-image u-image-circle" style="  width: 239px;height: 239px;  background-position: 50% 50%;margin: 0 auto;background-image:url({{asset('img/img1.png')}})" data-image-width="626" data-image-height="417">
              ...
              <div class="u-align-center u-container-style u-layout-cell u-palette-3-base u-size-20 u-layout-cell-2">
                <div class="u-container-layout u-valign-middle u-container-layout-2">
                  ...
                  <p class="u-text u-text-5">Image from
                      <a href="https://www.freepik.com/photos/business" class="u-active-none u-border-1 u-border-white u-btn u-button-link u-button-style u-hover-none u-none u-text-body-alt-color u-btn-1" target="_blank">
                        Freepik
                      </a>
                  </p>
                </div>
    ...
    {{-- <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-dd45"><div class="u-clearfix u-sheet u-sheet-1">
